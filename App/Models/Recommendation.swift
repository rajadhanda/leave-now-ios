...
// DisruptionSeverity is now defined in Disruption.swift to avoid duplication
...
// Legacy lightweight Recommendation removed to avoid conflict with public model
